...
function Header() {
  const { profileBoxOpen, setProfileBoxOpen } = useContext(UserContext);
            ...
            <>
              ...
              {profileBoxOpen && (
                <div className="absolute right-0 mt-3 w-44 bg-white rounded-xl shadow-lg border overflow-hidden">
                  <Link className="block px-4 py-2 hover:bg-indigo-50" to="/profile">
                    Profile
                  </Link>
                  <Link className="block px-4 py-2 hover:bg-indigo-50" to="/settings">
                    Settings
                  </Link>
